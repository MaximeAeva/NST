...
content_image = scipy.misc.imread(imagename)
...
style_image = scipy.misc.imread(texturename)
'''imshow(style_image);'''
...
def total_cost(J_content, J_style, alpha = 50, beta = 30):
    """
...
content_image = scipy.misc.imresize(content_image, (400, 320, 3))
content_image = reshape_and_normalize_image(content_image)

style_image = scipy.misc.imread(texturename)
style_image = scipy.misc.imresize(style_image, (400, 320, 3))
...
J = total_cost(J_content, J_style, alpha = 10, beta = 0.0001)
